...
public class Aims{
	...
	public static void main(String[] args) {
		...
		store.addMedia(dvd1); //method add (1)
		
		DigitalVideoDisc dvd2 = new DigitalVideoDisc("Star Wars","Science Fiction","George Lucas",87,19.95f);
		store.addMedia(dvd2); //method add (1)
		
		// only title , category and cost
		DigitalVideoDisc dvd3 = new DigitalVideoDisc("Aladin","Animation","Luong",180,18.99f);
		store.addMedia(dvd3); //method add (1)
				
		
		// public void addDigitalVideoDisc(DigitalVideoDisc[] dvdList) {
		DigitalVideoDisc dvd4 = new DigitalVideoDisc("5 anh em siêu nhân","animation");
		DigitalVideoDisc dvd5 = new DigitalVideoDisc("siêu nhân cuồng phong","animation");
		DigitalVideoDisc dvd6 = new DigitalVideoDisc("Nhạc sống Hà Tây"," music");
		DigitalVideoDisc dvd7 = new DigitalVideoDisc("Kẻ hủy diệt","fiction");
		
		CompactDisc cd1 = new CompactDisc("Yesterday","music","Phùng Khánh Linh");				
...
/*BLOCK 1:
	...
	/*The option “See a media’s details” will ask the user to enter the title of the media and
	display the information of that media (1). Please remember to check the validity of the title (2).*/
	public static void mediaDetails() {				
		String titleMedia = inputTitleMedia();								
		//display information of that media (1)
		Media selectedMedia = store.searchByTitle(titleMedia);
		selectedMedia.toString();
		/*the system also shows the following menu (note that the
		“Play” option is only available to CD and DVD type (3) */
	...
	/*The option “Add a media to cart” will ask the user to enter the title of the media that
	he/she sees on the screen (the list of medias in store), then add the media to cart.
	Please remember to check the validity of the title (2)
	After adding a DVD to cart, the system will display the number of DVDs in the current cart (3)*/
